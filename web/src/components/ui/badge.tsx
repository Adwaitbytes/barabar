...
const badgeVariants = cva(
  "inline-flex items-center gap-1 rounded-full border px-2 h-5 text-[11px] font-medium leading-none whitespace-nowrap transition-[filter,transform] duration-200 hover:brightness-110",
  {
    variants: {
      tone: {
